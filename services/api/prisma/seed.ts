...
export async function runSeed(): Promise<void> {
  ...
  // I18n ui-strings (en, hy, ru) — B11.2, idempotent upsert
  const enStrings: Record<string, string> = {
    ...
    "auth.loginTitle": "Sign in to MaxMarket",
    "orders.title": "Orders",
    ...
    "reports.exportPdf": "PDF export coming soon",
    "errors.insufficientStock": "Insufficient stock",
    "errors.forbidden": "Access denied",
    "errors.notFound": "Not found",
    "errors.conflict": "This item was modified by another user",
    "errors.network": "Unable to connect. Check your connection.",
    "errors.server": "Something went wrong. Please try again.",
    "errors.validation": "Please check the form for errors",
  };
  const hyStrings: Record<string, string> = {
    "nav.home": "Գլխավոր",
    ...
    "auth.loginTitle": "Մուտք MaxMarket",
    ...
    "actions.submit": "Ուղարկել",
    "actions.approve": "Հաստատել",
    "actions.reject": "Մերժել",
